...
{
    public class DataIngestion : IClassFixture<SampleTestFixture>
    {
        private readonly SampleTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SampleTestFixture fixture, ITestOutputHelper output)
        {
