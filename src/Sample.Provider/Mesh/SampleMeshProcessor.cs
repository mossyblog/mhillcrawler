...
{
    public class Sample_Command_MeshProcessor : BaseMeshProcessor
    {
        public Sample_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          SampleConstants.ProviderId;
